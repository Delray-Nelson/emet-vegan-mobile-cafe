  ...
  return (
    <div className="cart">
      <div className="cart-h">
        <h3>Your order</h3>
        <div className="cart-fulfill" role="tablist" aria-label="Fulfillment">
          <button className={"cart-seg" + (fulfillment === "pickup" ? " on" : "")}
            onClick={() => setFulfillment("pickup")}>Pickup</button>
          <button className="cart-seg" disabled title="Coming soon">Delivery · soon</button>
        </div>
      </div>
